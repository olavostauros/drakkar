...
wp_enqueue_style('drakkar-hero-main', get_template_directory_uri() . '/css/hero-zero.css', array(), '1.0.0');
wp_enqueue_script('drakkar-hero-main', get_template_directory_uri() . '/js/hero-main.js', array(), '1.0.0', true);
?>